if (pageid == "error") {
  ...
  if (errorid == "5") {
    $("#lbHeaderH2").text("Rejected queue number");
    $("#lbHeaderP").text(
      "There has been an error and your queue number has been rejected.  We have recorded the issue and apologise for any inconvenience."
    );
  }
  // KnownUserV3
  if (errorid == "6") {
